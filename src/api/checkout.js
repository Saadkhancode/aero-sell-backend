  ...
  await stripe.subscriptions.create({
    ...
    width: 100%; height: 14rem;background-color: rgb(6, 138, 245);font-size:22px; display:flex; align-items:end
       ...
       <div style="" class="head">
           <h2 style="color: white; padding-left: 10px; font-weight: bold;margin-bottom:2rem;width:100%;align-items:center">Payment Confirmation</h2>
       </div>
...
`)
   ...
   margin:0px;
      ...
      <body>
      <div class="container">
      <div style="font-family: Arial, Helvetica, sans-serif; border:1px solid lightgray">
      ...
      <div style="padding: 2rem;">
          ...
          <div style="display:grid; justify-content: center;">
              <p style="font-style: italic; margin-bottom: 5px; display: flex; justify-content: center;">Copyright (C) 2023 PatronWorks. All rights reserved.</p>
              ...
              <p style="margin-bottom: 5px; display: flex; justify-content: center;">Need some assistance? Reach out to us<a href="" style="margin-left: 5px; margin-right: 5px;">support@patronworks.com</a> </p >
          </div>
      </div>
   </div>
   </div>
